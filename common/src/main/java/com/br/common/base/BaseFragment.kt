...
import br.com.rba.common.extension.setupProgressBar
import br.com.rba.common.extension.setupSnackbar
import com.br.common.R
...
abstract class BaseFragment : Fragment() {
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        setupProgressBar(this, getViewModel().progressBarLoading, R.id.progress_bar)
    }
